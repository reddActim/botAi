        ...
        <>
            <Stack>
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ width: "100%", backgroundColor: "#D7C7F4", p: "0.75rem" }} >
                    ...
                    <Typography variant="h5" sx={{ color: "black", alignSelf: "center", fontWeight: "500", lineHeight: "100%", fontFamily: "Ubuntu", marginLeft:"0.5rem", marginRight:"0.5rem"   }}>New Chat</Typography>
